...
class EmployeeController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        $posts = employee::all();
        return $this->sendResponse(EmployeeResource::collection($posts), 'Employees retrieved successfully.');
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return $this->sendResponse(new EmployeeResource($requestData), 'Employee created successfully.');
    ...
    public function show(string $id): JsonResponse
    {
        ...
        return $this->sendResponse(new EmployeeResource($company), 'Employee retrieved successfully.');
